...
<html>
    <head>
        <meta charset="UTF-8">
        <title>GALERIA-Hotel Rural Sierra de Gata</title>
   ...
   .text {
    ...
    <body style="height: 100%;background-color:#EDEDED;font-family: Arial, Helvetica, sans-serif;">     <!--WHITE NAV -->
     ...
     <!-- LOGIN BUTTON -->
         ...
         <!-- SUBCLASS UL/LI -->     
             <div style="float:left;height:35px;width:50%;">
                 <ul class="effect-underline" id="navigation">
                   ...
                   <li id="contacto" class="lista1"><a href="contacto.php">CONTACTO </a></li>
               </ul>
             </div>   
          <!-- main -->
       ...
       <!--PICTURES-->
       <div  class="rooms" style="height:890px;width:100%;background-color: #EDEDED;margin-top:35px;">
            <br>
            <h1 style="padding-bottom:10px;text-align:center;color:#293456;font-weight:bold;font-family: 'Rokkitt',Georgia,Times New Roman,serif;font-size:250%;">GALERÍA II</h1>
            <!--FIRST PICTURE-->
            <div  id="first_room" style="float: left;height:20%;width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img class="zoom" style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/Escalda_en_Fitz_Roy,_Chaltén_-_Argentina.jpg">
                    </a>
            </div>
            <!--2 PICTURE-->
            <div id="first_room" style="float: left;height:20%; width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/paintball.jpg">
                    </a>
            </div>
            <!--3 PICTURE-->
            <div id="first_room" style="float: left;height:20%; width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/rutas-senderismo-albacete.jpg">
                    </a>
            </div>
            <!--4 PICTURE-->
            <div id="first_room" style="float: left;height:20%; width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/rutas4.jpg">
                    </a>
            </div>
            <!--5 PICTURE-->
            <div id="first_room" style="float: left;height:20%;width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/piscina-natural-extremadura-728.jpg">
                    </a>
            </div>
            <!--6 PICTURE-->
            <div id="first_room" style="float: left;height:20%; width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/manos-con-aceitunas1.jpg">
                    </a>
            </div>
            <!--7 PICTURE-->
            <div id="first_room" style="float: left; height:20%;width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/embalse_gabrielygalan.jpg">
                    </a>
            </div>
            <!--8 PICTURE-->
            <div id="first_room" style="float: left; height:20%;width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;"src="images/galeria2/villanueva-sierra.jpg">
                    </a>
            </div>
            <!--9 PICTURE-->
            <div id="first_room" style="float: left;height:20%; width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/que-ver-caceres-1.jpg">
                    </a>
            </div>
            <!--10 PICTURE-->
            <div id="first_room" style="float: left;height:20%;width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/00753687.jpg" >
                    </a>
            </div>
            <!--11 PICTURE-->
            <div id="first_room" style="float: left;height:20%;width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/bastones-senderismo-6.jpg">
                    </a>
            </div>
            <!--12 PICTURE-->
            <div id="first_room" style="float: left;height:20%; width: 20%;margin-left:3%;margin-top:2%;">
                    <a href="index.php">
                        <img  style="width:100%;height: 100%;border:5px inset wheat;" src="images/galeria2/20151007125243-caceres-pinofranqueado.jpg">
                    </a>
            </div>
            <table style="border: hidden;text-align:center;">
                <td style="border: hidden">
                 <a href="galeria.php"><img style="margin-right:5%;height:100px;width:150px;padding-top:5%;"src="images/galeria2/flecha.volver.svg"></a>
                </td>
