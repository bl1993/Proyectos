...
<html>
    <head>
        ...
        <title>CONTACTO-Hotel Rural Sierra de Gata</title>
    ...
    .contact {
        height:950px;width:100%;background-color: #ededed;padding-top:50px;text-align:center;
        
    }
    
    .contact-in {
         width:50%;height:90%;margin-left:auto;margin-right:auto;
    }
    .contact input  {
...
.textarea_contact{
    ...
    <body style="background-color:#EDEDED;font-family: Arial, Helvetica, sans-serif;">
     ...
     <!-- LOGIN BUTTON -->
       ...
       <!--CONTACT FORM-->
       <div  class="contact" >
                <a name="contacto-formulario"></a>
                <h1 style="width: 16%;margin-left:auto;margin-right:auto;color:#293456;font-weight:bold;font-family: 'Rokkitt',Georgia,Times New Roman,serif;font-size:250%;">CONTACTO</h1>
                <div class="contact-in">
        <!--FORM-->
                    
                        <input  type="text" id="nombre" name="your-name" value="*Nombre" size="40" class="contact-input" aria-required="true" aria-invalid="false">  
                         <input  type="text" id="email"name="your-email" value="*Email" size="40" class="contact-input" aria-required="true" aria-invalid="false">  
                         <input  type="text" id="telefono"name="your-phone" value="*Teléfono" size="40" class="contact-input" aria-required="true" aria-invalid="false">  
                         <input  type="text" id="subject"  value="Asunto" size="40" class="contact-input" aria-required="true" aria-invalid="false">  

                         <textarea name="your-message" id="message" cols="40" rows="10" class="textarea_contact" aria-invalid="false">*Mensaje</textarea> 
                             <div style="height: 20%;width:50%;text-align:left;margin-right:auto;margin-left:auto;font-family: 'Rokkitt',Georgia,Times New Roman,serif;">
                                 <div style="position: absolute;float:left;height: 40%;width:10%;text-align:right;margin-right:auto;margin-left:auto;">
                                     <input type="checkbox">
                                 </div>
                                 <div style="padding-top:25px;position:absolute;left:45%;;float:left;height:10%;width:75%;text-align:left;margin-right:auto;margin-left:auto;">
                                     <p>He leído y acepto las <a style="text-decoration:underline;color:blue;" href="https://policies.google.com/terms?hl=es">condiciones</a></p>
                                 </div>
                                 <div style="padding-left:55px;position:absolute;width:45%;margin-right:auto;margin-left:auto;padding-top:35px;">
                                     <input style="background-color:darkcyan;width: 30%;margin-left:40px;position: absolute;" id="submit" type="submit" value="Enviar">
                                 </div>
      ...
      <div class="footer" style="height:250px;background-color:#1F2E34;text-align: center;">
          <div style="position: relative;top:15%;left:5%;height:130px;width: 85%;margin-top:5px;">
              ...
              <div style="float:left;height:30px;width:100%;color:#d5d5d5;font-family: 'EB Garamond', serif;line-height:2; ">
                  <p style="color:#d5d5d5">© Copyright 2021. Todos los derechos reservados </p>
