...
<html>
        ...
        <?php require_once "scripts.php"; ?>
         ...
         <style>
         .login-form {
        height:55%;width:100%;background-color: #ededed;margin-top:8%;text-align:center;
    ...
    display:block;
        ...
        .register{
            height:65%;width:100%;background-color: #ededed;margin-top:8%;text-align:center;
        }
        .register h1 {
            text-align:center;color:#293456;font-weight:bold;font-family: 'Rokkitt',Georgia,Times New Roman,serif;font-size:250%;padding-bottom: 40px;
        }
    .register fieldset {
            background-color: #eeeeee;
            border: 3px darkcyan inset;
            width: 40%;
            margin-left: auto;
            margin-right: auto;
            text-align: center; 
    ...
    <body style="height:1200px;background-color:#EDEDED;font-family: Arial, Helvetica, sans-serif;">
     ...
     <!-- LOGIN BUTTON -->
            <div style="float:right;">
                <div class="container">
                   ...
                   <div class="overlay">
                       <div class="text"><a class="login_link" href="./acceso.php">Iniciar Sesión</a></div>
                   </div> 
               </div> 
            </div>
        </div>
      ...
      <div class="register">
          <a id="registro_usuarios"></a>
          <form id="frmRegistro">
           <fieldset>
               <legend class="label-1-fieldset">REGISTRATE</legend>
                 <label>Nombre</label>
		<input type="text" placeholder="Introduce tu Nombre" id="nombre" name="">
                <br><br>
		<label>Apellido</label>
                <input type="text" placeholder="Introduce tu Apellido" id="apellido" name="">
                <br><br>
                 <label for="user"><b>Usuario</b></label>
                 <input type="text" placeholder="Introduce tu usuario" id="usuario" name="email">
                 <br><br>
                 <label for="pwd"><b>Contraseña</b></label>
                 <input type="password" placeholder="Introduce tu contraseña" id="password" name="pwd">
                 <br><br>
                 
                    <table class="table-reg">
                        <td class="table-reg-td1"></td>
                    </table>
                 <span class="btn btn-primary" id="registrarNuevo" style="background-color:green;font-size: 120%;">Registrarse</span>
                 <div>
                     <br>
                     <p style="text-align:center;font-size:120%;">¿Ya tienes una cuenta? <a href="acceso.php#acceso_usuarios">Inicia sesión</a>.</p>
                 </div>
           </fieldset>     
        </form>
       </div>
      ...
      <!--FOOTER-->
      <footer style="height:20%;background-color:#1F2E34;text-align: center;">
          <div style="position: relative;top:15%;left:5%;height:130px;width: 85%;">
      ...
      <a style="background-color:darkcyan;font-size:120%;">
</body>
</html>
						...
						success:function(r){
							...
							if(r==2){
								...
								alertify.success("Agregado con exito");
                                                                alertify.alert("<b>Te has registrado correctamente en nuestra página.<br><br><center><a href='acceso.php#acceso_usuarios' style='color:darkcyan;font-size:150%;'>Inicia Sesión</a></b>");
							}else{
