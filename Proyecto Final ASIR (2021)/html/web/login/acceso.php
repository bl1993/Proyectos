    ...
    <body style="height:1200px;background-color:#EDEDED;font-family: Arial, Helvetica, sans-serif;">
     ...
     <!-- LOGIN BUTTON -->
            <div style="float:right;">
                ...
                <div class="overlay">
                       <div class="text"><a class="login_link" href="acceso.php#acceso_usuarios">Iniciar Sesión</a></div>
      ...
      <!--LOGIN FORM-->
      <a id="acceso_usuarios"></a>  <!--ANCLA-->
      <div class="login-form" >
          <form action="../login/acceso_usuarios/inicio.php" method="post" >
                <fieldset>  
                    <legend class="label-1-fieldset">ACCESO USUARIOS </legend>
                     <img src="./images/access.svg" style="height:8em;margin-top:2%;" alt="Avatar" class="avatar">
                     <br>
                     <label style="" for="uname" name="usuario" ><b>Usuario</b></label>
                     <input type="text" id="usuario" placeholder="Introduce tu usuario" name="uname" required>
                     <br><br>
                     <label  for="uname" name="pass" ><b>Contraseña</b></label>
                     <input type="password" id="password" placeholder="Introduce tu contraseña" name="psw" required>
                     <br><br>
                    
                     <span >¿No tienes cuenta?,  <a style="font-size:120%;"  href="registro.php#registro_usuarios">REGISTRATE</a></span>
                     <br><br>
                     <span>¿Eres trabajador del hotel?<a style="font-size:120%;"  href="acceso_empleados.php#acceso_empleados"> Inicia sesión</a></span>
                    
                     
                     <br><br>
                     <input type="submit" name="login_" id="entrarSistema">
                     <br><br>
                </fieldset>   
            </form> 
             <br>
      ...
      <!--FOOTER-->
      <div class="footer" style="height:25%;background-color:#1F2E34;text-align: center;overflow: auto;">
