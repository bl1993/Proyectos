                            ...
                            <div class="col-sm-12">
                                    <div class="jumbotron">
                                        <div class="welcome-div">
                                            ...
                                            ?>
                                                    <center> <span class="welcome-span">Bienvenido <?php  echo $nom ; echo "  " .$apell;  ?></span></center>
                                            <br><br>
                                                <ul>
                                                    <li><a href="horario_trabajo.php">Consultar horario de trabajo</a></li>
                                                    <li><a href="condiciones_laborales.php">Consultar condiciones laborales</a></li>
                                                </ul>
                                            <br>
                                            <center>
