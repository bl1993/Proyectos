...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Historia-Hotel Rural Sierra de Gata</title>
    ...
    .historia
    {
       height:500px;width:100%;background-color:white;text-align:center;
       font-family:  'Rokkitt',Georgia,Times New Roman,serif;
    }

    .historia-2
    {
               height:1250px;width:100%;background-color:#ededed;padding-top:25px;text-align:center;
               font-family:  'Rokkitt',Georgia,Times New Roman,serif;
    ...
    <body style="background-color:#EDEDED;font-family: Arial, Helvetica, sans-serif;">
     ...
     <!-- LOGIN BUTTON -->
             ...
             <div style="overflow:auto ;float:left;height:35px;width:50%;">
                 <ul class="effect-underline" id="navigation">
                     <li id="hotel" class="lista1">
                        <a href="index.php"class="hotel">HOTEL</a>
                        <ul class="submenu">
                   ...
                   <li id="entorno" class="lista1"><a href="habitaciones.php#habitaciones-enf">HABITACIONES </a></li>
                   <li id="reservas"class="lista1"><a >RESERVAS</a></li>
       ...
       <!--HISTORIA-->
          <h1 style="text-align:center;color:#293456;font-weight:bold;font-family: 'Rokkitt',Georgia,Times New Roman,serif;font-size:250%;margin-top: 2%;padding-top: 1%;">HISTORIA</h1>
       
       <div  class="historia" >
            <br>
            <h1>VILLANUEVA DE LA SIERRA</h1>
            <br>
            <p> Villanueva de la Sierra es una villa y municipio español de la provincia de Cáceres, Extremadura.
                
                <br> <br>Pertenece a la mancomunidad integral de la Sierra de Gata en el norte de la provincia de Cáceres y su término municipal limita con las mancomunidades del Valle del Alagón y de Trasierra . 
                <br> <br> Se sitúa en la falda del monte conocido como «Sierra de Dios Padre», de ahí el nombre de la localidad.
                <br><br>La villa es conocida por celebrar desde 1805 cada año el 26 de febrero la Fiesta del Árbol de Villanueva de la Sierra, festividad declarada Bien de Interés Cultural por ser el primer evento del Día del Árbol que se celebró en el mundo.1​</p>
            <img style="height: 50%;width: 55%;padding-top:1%;padding-bottom:2%;" src="./images/villanuevadelasierra_maquinaria_aceitera_1906x600_q75_middle.jpg">
       </div>
        <div  class="historia-2" >
                     
            <h1>AGRICULTURA FAMILIAR</h1>
            <br><br> Es una práctica de carácter agrícola que se caracteriza porque la mano de obra se compone de familias que buscan su propio auto-abastecimiento.
            <br><br>Esta labor es muy común en poblaciones rurales aisladas del mundo urbano,<br><br> que requieren satisfacer sus necesidades alimentarias cada día o generar ingresos a través de la producción de alimentos que suelen ser orgánicos y libres de agentes químicos (Aceitunas).
            <br><br>
            <img style="height: 35%;width: 40%;padding-top:2%;padding-bottom:2%;" src="./images/recolección-aceituna-melgarejo3.jpg">
            <br><br>En este caso, el origen del <b>HOTEL RURAL SIERRA DE GATA</b> , se debe a la familia <b>LAJAS-IZQUIERDO</b> , una idea de Antonio y Facunda para aprovechar al máximo el entorno rural de la zona.
            <br><br>
            <img style="float:left;height: 35%;width: 20%;margin-left: 10%;padding-top:2%;" src="./images/facunda-antonio.png">
            <img style="float:left;height: 35%;width: 30%;margin-left: 5%;padding-top:2%;" src="./images/00294514.jpg">
            <img style="float:left;height: 35%;width: 20%;margin-left: 5%;padding-top:2%;" src="./images/antonio-joven2.png">
      ...
      <div class="footer" style="height:250px;background-color:#1F2E34;text-align: center;">
          <div style="position: relative;top:15%;left:5%;height:130px;width: 85%;margin-top:5px;">
              ...
              <div style="float:left;height:130px;width:30%;">
                  <img src="./images/captura de pantalla(2).png" style="height:90%;width:80%; margin-left: auto;margin-right: auto;margin-top: 2%;display: block;">
              </div> 
