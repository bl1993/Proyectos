...
<html>
    <head>
        <meta charset="UTF-8">
        <title>SERVICIOS-Hotel Rural Sierra de Gata</title>
    ...
    <body style="background-color:#EDEDED;font-family: Arial, Helvetica, sans-serif;">
     ...
     <!-- LOGIN BUTTON -->
       ...
       <!--SERVICES-->
       <div  class="services" style="height:650px;width:100%;background-color: #ededed;margin-top:35px;">
            <a name="servicios-disponibles"></a><!--ANCLA-->
            <br>
            <h1 style="text-align:center;color:#293456;font-weight:bold;font-family: 'Rokkitt',Georgia,Times New Roman,serif;font-size:250%;padding-bottom: 40px;">SERVICIOS</h1>
            
            <!--FIRST SERVICE-->
           
            <div  id="first_service" style="height:20%; width:80%;margin-left: 10%;border:2px inset window ;border-left: 6px solid #2196F3;display:none;">
                <div  style="float:left;height:100%; width:20%;border-right:1px solid">
                    <img style="height:100%;width:100%;"src="images/galeria2/bastones-senderismo-6.jpg">
                </div>
                <!--DESCRIPTION-->
                <div style="float:left;height:100%; width:60%;border-right:1px inset;background-color:#DFE5E5;">
                    <div style="height:15%; width:10%;margin-right:auto;margin-left:auto;">
                         <span style="text-align:center;color:white;background-color:darkcyan;font-weight:bold;font-family: 'Rokkitt',Georgia,Times New Roman,serif;font-size:100%;">RUTAS</span> 
                    </div>
                    
                         <p>Entorno fluvial – Robledillo de Gata</p>
                         <p>Embalse de Borbollón – Santibáñez El Alto</p>
                         <p>Penamacor-Portugal</p>
                </div>     
                <!--PRICE-->
                <div style="float:left;height:100%; width:20%;padding-top:2%;text-align: center;">
                    <p style="">Desde <label style="color:#8b0000">10.00€</label> </p>
                    <button style="height:40px;background-color:darkcyan;"type="submit" ><a>RESERVAR</a></button>
                </div>
            </div>
            <!--SECOND SERVICE-->
            <div id="second_service" style="height:20%; width:80%;margin-left: 10%;margin-top:3%;border:2px inset window ;display:none;border-left: 6px solid #2196F3;">
                <div  style="float:left;height:100%; width:20%;border-right:1px solid">
                    <img style="height:100%;width:100%;"src="./images/galeria2/Escalda_en_Fitz_Roy,_Chaltén_-_Argentina.jpg">
                </div>
                <!--DESCRIPTION-->
                <div style="float:left;height:100%; width:60%;border-right:1px inset;background-color:#DFE5E5;">
                    <div style="height:15%; width:10%;margin-right:auto;margin-left:auto;">
                        <span style="text-align:center;color:white;background-color:darkcyan;font-weight:bold;font-family: 'Rokkitt',Georgia,Times New Roman,serif;font-size:100%;">ESCALADA</span>
                    </div>
                     <p>Escalada Alange - Badajoz.</p>
                     <p>Escalada Sierra del Castellar - Zafra.</p>
                     <p>Escalada La Roca de la Sierra - Badajoz.</p>
                </div>     
                <!--PRICE-->
                <div style="float:left;height:100%; width:20%;padding-top:2%;text-align: center;">
                    <p style="">Desde <label style="color:#8b0000">25.00€</label> </p>
                    <button style="height:40px;background-color:darkcyan;"type="submit" ><a>RESERVAR</a></button>
                </div>
            </div>
            <!--THIRD SERVICE-->
            <div id="third_service" style="height:20%; width:80%;margin-left: 10%;border:2px inset window;margin-top:3%;display:none;border-left: 6px solid #2196F3;">
                <div  style="float:left;height:100%; width:20%;border-right:1px solid">
                    <img style="height:100%;width:100%;"src="images/galeria2/paintball.jpg">
                </div>
                <!--DESCRIPTION-->
                <div style="float:left;height:100%; width:60%;border-right:1px inset;background-color:#DFE5E5;">
                    <div style="height:15%; width:10%;margin-right:auto;margin-left:auto;">
                        <span style="text-align:center;color:white;background-color:darkcyan;font-weight:bold;font-family: 'Rokkitt',Georgia,Times New Roman,serif;font-size:100%;">PAINTBALL</span>
                    </div>
                    <p>Campo de paintball situado en Sierra de Fuentes.</p>
                    <p>Paintball infantil 7-14 años.</p>
                    <p>Paintball adulto +14 años.</p>
                </div>     
                <!--PRICE-->
                <div style="float:left;height:100%; width:20%;padding-top:2%;text-align: center;">
